/// @description scr_actA_heal_large(return)
/// @param return
function scr_actP_heal_large(argument0) {
	/*
		This is the most basic party attack
	*/

	// Set the properties of the action
	var act_name = "Heal Large";
	var act_cost = 15;
	...
	if return_arg == ACT_NAME {
		...
		switch act_time1 {
			case 1:
				create_effect(s_heal_large_1, acting.target.x, acting.target.y);
			break;
